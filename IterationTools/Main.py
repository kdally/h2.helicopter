...
for i in range(10):
    ...
    aircraft.plotFlight('time','thrusta')
    aircraft.roundtime()
    ...
    powers, times, hs, v_infs, angles, mission_profile, mission_time, dcts, omegas, collectives, inflows, dcps, Machs, cts, cps = rp.finalsim(alex_data,rotor,chord)
    ...
    gearbox_mass = 266 #  is the mass of the 2 gearboxes
    ...
    wing_mass_h, mass_fractions_h, areas_h = ws.wingstructure(M_h, Sy_h, T_h, b)
    ...
    prop = [0,rp.calcRotorWeight(rotor)[2]+140-14]
    wing = [0,wing_mass]
...
with open('finaldata_last_week.pickle', 'wb') as handle:
